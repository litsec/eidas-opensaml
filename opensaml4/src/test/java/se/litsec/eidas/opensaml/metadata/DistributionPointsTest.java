...
public class DistributionPointsTest extends OpenSAMLTestBase {
  ...
  public void testMarshallAndUnmarshall() throws Exception {
    ...
    Assert.assertEquals(points.getDistributionPoints().get(0).getURI(), points2.getDistributionPoints().get(0).getURI());
    Assert.assertEquals(points.getDistributionPoints().get(1).getURI(), points2.getDistributionPoints().get(1).getURI());
  }
