...
public class CvaddressAreaBuilder extends AbstractXMLObjectBuilder<CvaddressArea> {
  ...
  public CvaddressArea buildObject() {
    return buildObject(EidasConstants.EIDAS_NP_NS, CvaddressArea.DEFAULT_ELEMENT_LOCAL_NAME,
      EidasConstants.EIDAS_NP_PREFIX);
  }

  /** {@inheritDoc} */
  @Override
  public CvaddressArea buildObject(String namespaceURI, String localName, String namespacePrefix) {
