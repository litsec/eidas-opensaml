...
/**
 * The {@code CvaddressArea} element of the {@code CurrentAddressStructuredType}.
 * 
 * @author Martin Lindström (martin.lindstrom@litsec.se)
 */
public interface CvaddressArea extends XSString {

  /** Element local name. */
  public static final String DEFAULT_ELEMENT_LOCAL_NAME = "CvaddressArea";
